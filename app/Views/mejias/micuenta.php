            ...
            <form method="post">
                <div class="row">
                    <div class="col-md-12">
                       ...
                       <input type="email" name="email" id="email" class="form-control inp-cuenta" value="<?=$usuario["email"]?>">
                       <div id="email-text" class="form-text"></div>
                    </div>
                </div>
                <div class="row mt-3">
                                ...
                                <div class="accordion-body">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-12 d-flex justify-content-center">
                                            <button disabled id="change-password" class="btn btn-warning">Cambiar Contraseña</button>
                                        </div>
                                    </div>
                                    <div class="alert alert-danger mt-4" id="alert-password" role="alert" hidden></div>
                                </div>
                            </div>
                        </div>
                    </div>
               ...
               <div class="row mt-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nombre" id="nombre" class="form-control inp-cuenta" value="<?=$usuario["nombre"]?>">
                    </div>
                    <div class="col-md-6">
                        <label for="apellido" class="form-label">1º Apellido:</label>
                        <input type="text" name="apellido" id="apellido" class="form-control inp-cuenta" value="<?=$usuario["apellido"]?>">
                    </div>
               </div>
               <div class="row mt-3">
                    <div class="col-md-12">
                        <label for="telefono" class="form-label">Nº Teléfono:</label>
                        <input type="tel" name="telefono" id="telefono" class="form-control inp-cuenta" value="<?=$usuario["telefono"]?>">
                        <div id="telefono-text" class="form-text"></div>
                    </div>
               </div>
               <div class="row mt-4">
                    <div class="col-md-6 d-flex justify-content-center">
                        <button disabled id="modifica" class="btn btn-primary">Modificar datos</button>
                    </div>
                    <div class="col-md-6 d-flex justify-content-center">
                        <a href="<?=base_url('logout')?>" class="btn btn-danger">Cerrar sesión</a>
                    </div>
               </div>
               <div class="alert alert-danger mt-4" id="alert-cuenta" role="alert" hidden></div>
            </form>
        </div>
    </div>
</div>

<script src="<?=base_url('assets/js/micuenta.js')?>"></script>
